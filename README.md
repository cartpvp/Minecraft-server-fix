...
5. В этом файле будет строка вида:
...
В ``--wf.tcp=`` вставьте скопированный порт или порты через запятую. Крайне рекомендую добавить порт 25565 чтобы заработало большинство серверов.

6. Под строкой из **5 пункта** вам нужно скопировать и вставить это:
...
7. Сохраняете файл и запускаете ALT.
